...
function Cell(game, spritesheet, x, y) {
...
AM.downloadAll(function () {
    ...
    for (var i = 0; i < 80; i ++) {
        for (var j = 0; j < 80; j ++) {
            if (Math.random() < .1) {
                gameEngine.addEntity(new Entity(gameEngine, i*10, j*10, i, j, true));
            } else {
		gameEngine.addEntity(new Entity(gameEngine, i*10, j*10, i, j, false));
            }
        }
    }
